...
----
include::ROOT:examples$bgd-helm-chart/Chart.yaml[]
----
...
[source,yaml,subs="+macros,attributes+"]
----
include::ROOT:examples$bgd-helm-chart/values.yaml[]
----
...
[source,yaml,subs="+macros,attributes+"]
----
include::ROOT:examples$bgd-app-helm.yaml[]
----
...
image::gitops-apps/bgd-helm1.png[]
...
image::gitops-apps/bgd-helm2.png[]
...
image::gitops-apps/bgd-helm3.png[]
...
image::gitops-apps/yellowoutput.png[]
...
image::gitops-apps/bgd-helm4.png[]
...
image::gitops-apps/bgd-green.png[]
...
[source,yaml,subs="+macros,attributes+"]
----
include::ROOT:examples$bgd-app-helm-para.yaml[]
----
...
image::gitops-apps/bgd-helm5.png[]
...
image::gitops-apps/bgd-purple.png[]
